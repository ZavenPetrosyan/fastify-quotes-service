...
export interface QuoteService {
  ...
  getQuotesWithFilter(filter?: any, sort?: any, limit?: number, offset?: number, userId?: string): Promise<QuoteWithStats[]>;
  ...
  createCollection(name: string, description: string | undefined, isPublic: boolean | undefined, userId: string): Promise<any>;
  ...
  compareQuotes(quoteIds: string[], analysisType?: string, includeMetrics?: boolean): Promise<any>;
  getSmartRecommendations(userId: string, limit?: number, algorithm?: string, includeExplanation?: boolean): Promise<any>;
